...
function example() {
    ...
    if (species === "Homo sapiens") {
        document.getElementById("input-TPOX").value = "8,10";
        document.getElementById("input-D2S441").value = "11,12";
        document.getElementById("input-D3S1358").value = "15";
        document.getElementById("input-D5S818").value = "10";
        document.getElementById("input-CSF1PO").value = "11,12";
        document.getElementById("input-F13A01").value = "14";
        document.getElementById("input-D6S1043").value = "11";
        document.getElementById("input-D7SS820").value = "8,12";
        document.getElementById("input-LPL").value = "11,12";
        document.getElementById("input-D8S1179").value = "11,14";
        document.getElementById("input-D10S1248").value = "14,16";
        document.getElementById("input-TH01").value = "6,9.3";
        document.getElementById("input-VWA").value = "18";
        document.getElementById("input-D13S317").value = "8,12";
        document.getElementById("input-FES/FPS").value = "10,11";
        document.getElementById("input-D16S539").value = "11";
        document.getElementById("input-D18S51").value = "13,21";
        document.getElementById("description").value = "JURKAT";
        document.getElementById("sample-human").innerHTML = "Example <span class='text-purple'>JURKAT</span> loaded";
